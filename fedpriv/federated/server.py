...
#         sensitivity = cfg.privacy.clip_norm / self.cohort_size
...
#                 result = client.local_train(self.global_params, self.model)
...
#             spend = self.accountant.spend_at_round(round_idx)
...
#             "final_noise_param": self.accountant.noise_param,
